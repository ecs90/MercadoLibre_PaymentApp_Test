...
public class CardRecyclerAdapter extends RecyclerView.Adapter<CardRecyclerAdapter.RecyclerViewHolder> {
    ...
    public CardRecyclerAdapter(Context mContext, List<PaymentMethodModel> list) {
    ...
    public PaymentMethodModel getSelected() {
